...
def handle_send():
    ...
    if fitur == "chatbot" and mode_bahasa == "Sunda":
        #bot_response_ekuivalen, pasangan_ganti_ekuivalen = ubah_ke_lema(bot_response, df_kamus)
    ...
    if option == "Terjemah Sunda → Indo":
        fitur = "terjemahsundaindo"
        #bot_response_ekuivalen, pasangan_ganti_ekuivalen = ubah_ke_lema(bot_response2, df_kamus)
        text_constraint = bot_response2
